...
def main(argv: list[str] | None = None) -> None:
    ...
    ap.add_argument("--tables", type=Path, default=EVID / "pilot/readout_tables.json")
    ap.add_argument("--detector-validity", type=Path, default=EVID / "detector/validity_summary.json")
    ap.add_argument(
    ...
    ap.add_argument(
        "--switch-bootstrap",
        type=Path,
        default=EVID / "ledger/switchaway_suppression_bootstrap.json",
    )
    ap.add_argument(
        "--switch-overlap",
        type=Path,
