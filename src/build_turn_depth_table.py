...
COVERAGE_PATHS = {
    "devset": EVID / "audit/coverage_devset.json",
    "val": EVID / "audit/coverage_val.json",
}
SIDECAR_PATHS = {
    "devset": EVID / "annotations/devset_exact_version.idkeyed.jsonl",
    "val": EVID / "annotations/val_exact_version.idkeyed.jsonl",
}
