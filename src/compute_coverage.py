"""Coverage of requested tracks in a ranking, and where the losses are.

Paper Section 5: for each audited directive, find the requested track's rank
in the supplied prediction list and bucket the outcome. It
...
from apply_request_override import load_predictions, request_directives  # noqa: E402
