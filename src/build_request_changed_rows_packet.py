...
Input rows are the `promoted` category of an analyze_request_postrank_coverage
...
from request_correction_labels import build_catalog_index, metadata_summary
