...
EVID = ROOT / "evidence"
DEFAULT_JSON = EVID / "audit/prevalence.json"
DEFAULT_MD = EVID / "audit/prevalence.md"
...
def main(argv: list[str] | None = None) -> None:
    ...
    ap.add_argument("--locked", type=Path, default=EVID / "audit/changed_rows.json")
    ap.add_argument("--robustness", type=Path, default=EVID / "audit/turn_depth.json")
    ap.add_argument("--paper-tables", type=Path, default=EVID / "pilot/readout_tables.json")
