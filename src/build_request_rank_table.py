...
2. From gated prediction files (--control-predictions/--specialist-predictions,
   regenerated via src/run_request_fulltrain_eval.py from the shipped model
...
DEFAULT_COVERAGE = EVID / "funnel/coverage_devset.json"
DEFAULT_PER_TURN = EVID / "results/table1_per_turn_ranks.idkeyed.jsonl"
