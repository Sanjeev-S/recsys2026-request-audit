...
intermediates stay local; use src/redact_annotations.py before sharing any sidecar.
"""
...
def main() -> None:
    ...
    funnel = {
        ...
        "changed_rows": len(packet),
        "changed_rows_label_differs": sum(1 for r in packet if not r.get("gold_is_requested")),
    }
