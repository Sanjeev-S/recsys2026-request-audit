...
|---|---|---|
| 82 directives, 41 conflicts, 1.0% of 8,000 turns (Section 5) | `run_audit.py` | `audit/coverage_devset.json`, `audit/prevalence.json` |
...
| Dialogue gate: identical scores outside gated turns (Section 6) | `gate_eval.py` | `results/table2_scores.md` |
...
| Hard artist: 74% action precision (Section 8) | `hard_artist_ladder.py` | `ledger/hard_artist_ladder.json` |
...
| Five screened and declined families (Section 8) | `family_ledger.py` | `ledger/family_search_ledger.json` |
